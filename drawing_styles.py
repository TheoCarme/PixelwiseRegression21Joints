...
def get_default_left_hand_landmarks_style() -> Mapping[int, DrawingSpec]:
  ...
  """
  hand_landmark_style = {}
  for k, v in _LEFT_HAND_LANDMARK_STYLE.items():
    for landmark in k:
      hand_landmark_style[landmark] = v
  return hand_landmark_style


def get_default_right_hand_landmarks_style() -> Mapping[int, DrawingSpec]:
  """Returns the default hand landmarks drawing style.
  ...
  """
  hand_landmark_style = {}
  for k, v in _RIGHT_HAND_LANDMARK_STYLE.items():
    for landmark in k:
      hand_landmark_style[landmark] = v
  return hand_landmark_style


def get_default_left_hand_connections_style(
  ...
  for k, v in _LEFT_HAND_CONNECTION_STYLE.items():
    for connection in k:
      hand_connection_style[connection] = v
  return hand_connection_style


def get_default_right_hand_connections_style(
) -> Mapping[Tuple[int, int], DrawingSpec]:
  """Returns the default hand connections drawing style.
  ...
  """
  hand_connection_style = {}
  for k, v in _RIGHT_HAND_CONNECTION_STYLE.items():
    for connection in k:
      hand_connection_style[connection] = v
  return hand_connection_style
